...
type Interface interface {
	...
	AddWithTrace(item interface{}, trace any)
	GetWithTrace() (item interface{}, shutdown bool, trace any)
}
...
func newQueue(c clock.WithTicker, metrics queueMetrics, updatePeriod time.Duration, coalesceFn func(a, b any) any) *Type {
	t := &Type{
		clock:                      c,
		dirty:                      set{},
		processing:                 set{},
...
func (q *Type) Add(item interface{}) {
	q.AddWithTrace(item, nil)
}

func (q *Type) AddWithTrace(item interface{}, b any) {
	q.cond.L.Lock()
	...
	if q.dirty.has(item) {
		if q.coalesceFunc != nil {
			a := q.traces[item]
			q.traces[item] = q.coalesceFunc(a, b)
		}
		return
	}
	...
	if q.coalesceFunc != nil {
		q.traces[item] = q.coalesceFunc(nil, b)
	}
...
func (q *Type) Get() (item interface{}, shutdown bool) {
	item, shutdown, _ = q.GetWithTrace()
	return item, shutdown
}

func (q *Type) GetWithTrace() (item interface{}, shutdown bool, trace any) {
	q.cond.L.Lock()
	defer q.cond.L.Unlock()
